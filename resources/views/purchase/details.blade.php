                ...
                <div class="modal-content">
                    <form :action="actionUrl" method="post" autocomplete="off" @submit="submitForm($event, data.id)">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="purchase_id">Id Purchase</label>
                                <input  name="purchase_id" class="form-control"
                                    placeholder="Enter purchase_id" :value="data.purchase_id" required="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input  type="text" name="subtotal" class="form-control"
                                    placeholder="Enter Harga Beli" :value="data.purchase_price" required="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="subtotal" class="form-control"
                                    placeholder="Enter Subtotal" :value="data.subtotal" required="">
                            </div>
                        </div>
...
@section('js')
    ...
    <script type="text/javascript">
        var actionUrl = '{{ url('purchases-details') }}';
        var apiUrl = '{{ url('api/purchases-details') }}';
        var columns = [{
                data: 'DT_RowIndex',
                class: 'text-center',
                orderable: true
