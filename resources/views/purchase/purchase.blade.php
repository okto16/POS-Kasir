    ...
    <div id="controller">
        <div class="d-flex mb-3">
            <div class="flex-grow-1">
                <a href="{{ route('purchases.create') }}" class="btn btn-primary"> Create
                    New Purchase</a>
            </div>
        </div>
        ...
        var columns = [{
            ...
            },
            {
                render: function(index, row, data, meta) {
                    return `
                <a href="{{ url('purchases/${data.id}/edit') }}" class="btn btn-sm btn-warning" @click="editData(id, $event)">Edit</a>
